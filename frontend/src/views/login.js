...
export default {
    ...
    methods: {
        switcher: (e) => {
            ...
            document.getElementById(e.target.dataset.type).classList.add('hide')
        },
        hrefToRegister: (e) => {
        ...
        sendRegisterForm: () => {
            ...
            register(data, registerForm.querySelector('[name="usernametoregister"]+.alert'),registerForm.querySelector('[name="email"]+.alert'),registerForm.querySelector('[name="pwdtoregister"]+.alert'),registerForm.querySelector('[name="pwdtoconfirm"]+.alert'))
        }
    },
    template: `
        <div id="inputarea"  class="card">
            ...
            <form id="loginform">
                ...
                <div class="coolinput" id="pwdtologin">
            ...
            <form id="registerform" class="hide">
                ...
                <div class="coolinput" id="pwdtoregister">
                ...
                <div class="coolinput" id="pwdtoconfirm">
    ...
    afterMount: function() {
        ...
        document.querySelectorAll('.coolinput>svg').forEach(item => {
